...
class BusinessRegistrationAdmin(admin.ModelAdmin):
    ...
    fields = ('user', 'business_name', 'address', 'owner_name', 'authorized_person_name', 'business_location', 'type_of_business', 'dealing_with', 'business_name_board_photo', 'authorized_person_photo', 'mobile_number', 'email_id')
